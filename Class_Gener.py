...
class TaskGenerator():
    ...
    def questions_for_kr_ballistics(self):
        return choice([
            "Что называется баллистическим движением?",
            "Какие силы учитываются в идеальной баллистической задаче?",
            "Почему траектория тела в баллистике всегда парабола?",
            "Как угол броска влияет на дальность полёта тела?",
            "Что такое горизонтальная дальность полёта?",
            "Как зависит время полёта от начальной скорости при баллистическом движении?",
            "Каковы особенности движения тела, брошенного горизонтально?",
            "Почему максимальная дальность полёта достигается при угле 45°?",
            "Как изменится траектория, если учесть сопротивление воздуха?",
            "Что называется временем подъёма и временем падения в баллистике?"
        ])


    def tests_for_kr_ballistics(self):
        return choice([
            "Тело брошено под углом 30° к горизонту. Как направлен вектор его скорости в наивысшей точке траектории?\nА) Горизонтально\nБ) Вертикально вверх\nВ) Под углом 30° к горизонту\nГ) Вертикально вниз",
            "Как изменится время полёта тела, брошенного под углом к горизонту, если начальную скорость увеличить в 2 раза?\nА) Увеличится в 2 раза\nБ) Увеличится в 4 раза\nВ) Уменьшится в 2 раза\nГ) Не изменится",
            "Два тела брошены с одинаковой скоростью: первое - под углом 30°, второе - под углом 60° к горизонту. Соотношение дальностей полёта этих тел будет:\nА) 1:1\nБ) 1:√3\nВ) √3:1\nГ) 1:2",
            "При каком угле бросания дальность полёта будет равна максимальной высоте подъёма?\nА) 30°\nБ) 45°\nВ) 60°\nГ) 76°",
            "Тело брошено горизонтально с высоты h. Как изменится время падения, если высоту увеличить в 4 раза?\nА) Увеличится в 2 раза\nБ) Увеличится в 4 раза\nВ) Уменьшится в 2 раза\nГ) Не изменится"
        ])


    def questions_for_kr_mechanics(self):
        return choice([
            ...
            "Как определяется кинетическая энергия тела?",
            "Сформулируйте закон Гука",
            "Что называется коэффициентом трения?",
            "Какие виды трения вы знаете?"
        ])


    def tests_for_kr_mechanics(self):
        return choice([
            "Какое из утверждений соответствует первому закону Ньютона?\nА) Сила равна произведению массы на ускорение\nБ) Тело сохраняет состояние покоя или равномерного движения, пока внешние силы не заставят его изменить это состояние\nВ) Действию всегда есть равное и противоположное противодействие\nГ) Импульс системы сохраняется",
            "Если массу тела увеличить в 2 раза, а силу уменьшить в 2 раза, то ускорение:\nА) Не изменится\nБ) Увеличится в 2 раза\nВ) Уменьшится в 4 раза\nГ) Уменьшится в 2 раза",
            "Лодка массой 100 кг движется со скоростью 1 м/с. Человек массой 50 кг прыгает с лодки со скоростью 2 м/с в направлении, противоположном движению лодки. Какова скорость лодки после прыжка?\nА) 1.5 м/с\nБ) 2 м/с\nВ) 0.5 м/с\nГ) 3 м/с",
            "Какая из перечисленных сил является консервативной?\nА) Сила трения\nБ) Сила сопротивления воздуха\nВ) Сила тяжести\nГ) Сила натяжения нити",
            "Тело массой 2 кг под действием силы 10 Н движется с ускорением:\nА) 0.2 м/с²\nБ) 5 м/с²\nВ) 10 м/с²\nГ) 20 м/с²"
        ])
