...
acceleration=[equidistant_acceleration_first(), equidistant_acceleration_second()]
final_speed=[equidistant_final_speed_first(), equidistant_final_speed_second()]
start_speed=[equidistant_start_speed_first(), equidistant_start_speed_second(), equidistant_start_speed_third()]
time=[equidistant_time_first(), equidistant_time_second()]
distance=[equidistant_distance_first(), equidistant_distance_second()]
