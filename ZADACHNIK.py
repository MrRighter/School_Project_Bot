...
class Interface():
    ...
    def __init__(self, page):
        ...
        self.InputA = TextField(value='', width=200, label="Количество задач", visible=False)
    ...
    def get_Setup2(self):
        ...
        row4 = Row([self.InputA, self.TXTPROVERKA, self.PDFPROVERKA], alignment=self.Standartaligment)
